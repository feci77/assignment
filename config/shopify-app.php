    ...
    */
    ...
    'webhooks' => [
            [
                ...
                'address' => env('SHOPIFY_PRODUCT_CREATE_URL', env('APP_URL').'/api/webhook/products-create')
            ],
            [
                'topic' => 'PRODUCTS_UPDATE',
                'address' => env('SHOPIFY_PRODUCT_UPDATE_URL', env('APP_URL').'/api/webhook/products-update')
            ],
            [
                'topic' => 'APP_UNINSTALLED',
                'address' => env('SHOPIFY_PRODUCT_APP_UNINSTALLED_URL', env('APP_URL').'/api/webhook/app/uninstalled')
            ],
    ],
